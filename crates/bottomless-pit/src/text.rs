...
pub(crate) fn measure_text(text: &str, brush: &mut wgpu_glyph::GlyphBrush<()>, scale: f32) -> Vec2<f32> {
    ...
    let rect = brush.glyph_bounds(section).unwrap_or(wgpu_glyph::ab_glyph::Rect{
